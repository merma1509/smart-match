...
class OCRPostProcessor:
    ...
    def __init__(self):
        ...
        self.genealogy_dict = {
            ...
            "родился": "родился", "родилась": "родилась",
            "родившись": "родился",
            "умер": "умер", "умерла": "умерла",
            "скончался": "скончался", "скончалась": "скончалась",
            "крещён": "крещён", "крещена": "крещена",
            "венчался": "венчался", "венчалась": "венчалась",
            "погребён": "погребён", "погребена": "погребена",
            "похоронен": "похоронен", "похоронена": "похоронена",
            ...
            "мать": "мать", "мат": "мать",
            "муж": "муж", "жена": "жена",
            "супруг": "супруг", "супруга": "супруга",
            "брак": "брак", "бракосочетание": "бракосочетание",
            
            # Russian common names
            "иван": "Иван", "анна": "Анна",
            "мария": "Мария", "пётр": "Пётр", "петр": "Пётр",
            "александр": "Александр", "алексей": "Алексей",
            "екатерина": "Екатерина", "елена": "Елена",
            "ольга": "Ольга", "татьяна": "Татьяна",
            "надежда": "Надежда", "николай": "Николай",
            "михаил": "Михаил", "владимир": "Владимир",
            "дмитрий": "Дмитрий", "сергей": "Сергей",
            
            # Russian common surnames
            "иванов": "Иванов", "петров": "Петров",
            "сидоров": "Сидоров", "кузнецов": "Кузнецов",
            "смирнов": "Смирнов", "попов": "Попов",
            "васильев": "Васильев", "зайцев": "Зайцев",
            "соколов": "Соколов", "михайлов": "Михайлов",
            "фёдоров": "Фёдоров", "федоров": "Фёдоров",
            "белов": "Белов", "козлов": "Козлов",
            "новиков": "Новиков", "морозов": "Морозов",
            "волков": "Волков",
        }
    ...
    def merge_hyphenated_words(self, text: str) -> str:
        ...
        text = re.sub(r'(\w+)-\s+(\w+)', lambda m: 
                      m.group(1) + m.group(2) if len(m.group(1)) > 2 else m.group(0), text)
        return text
